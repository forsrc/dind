...
sleep 5
docker exec -i -u root k8s-master sh -c "cat >init_with_ssh.sh" < init_with_ssh.sh
docker exec -i -u root k8s-master sh -c "chmod +x /init_with_ssh.sh && /init_with_ssh.sh"
